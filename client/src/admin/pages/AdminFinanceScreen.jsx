        ...
        <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-6">
          ...
          <section className="space-y-6">
            <div className="rounded-2xl border border-cyan-500/20 bg-gradient-to-r from-[#0f172a]/95 via-[#111827]/95 to-[#0b1324]/95 p-6">
              ...
              <p className="text-gray-300 mt-2">Commission tracking, payouts, and settlement monitoring will be managed here.</p>
            </div>
            <div className="bg-[#0f172a] border border-white/10 rounded-2xl p-6 text-gray-300">
              This page is now routable and ready for the finance module implementation.
            </div>
          </section>
        </div>
      </main>
